...
<html lang="en">
<head>
    <link rel="stylesheet" href="assets/facturas.css">
    <meta charset="UTF-8">
    ...
    <div id="navegacion">
        <nav>
          <ul>
            ...
            <li class="FACTURAS"><a href="">FACTURAS</a></li>
                ...
                <table class="tabladat">
                        ...
                        <thead>
                          ...
                          <tr>
                            ...
                            <th ><input type="text" name="Productos" placeholder="Cantidad de productos"></th>
